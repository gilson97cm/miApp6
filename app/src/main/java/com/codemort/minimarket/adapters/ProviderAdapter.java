...
import com.codemort.minimarket.ui.activities.Home;
import com.codemort.minimarket.ui.activities.Login;
import com.codemort.minimarket.ui.activities.MyOrders;
import com.codemort.minimarket.ui.activities.PresentationActivity;
...
public class ProviderAdapter extends RecyclerView.Adapter<ProviderAdapter.ProviderViewHolder> {
    ...
    public void updateList(ArrayList<ProviderVo> dealList_) {
        this.listProviders = new ArrayList<>();
        this.listProviders.addAll(dealList_);
                ...
                public void onResponse(String response) {
                    ...
                    if (response.trim().equalsIgnoreCase("elimina")) {
                        ((FragmentActivity)context).getSupportFragmentManager().beginTransaction()
                                .replace(R.id.fragmentProvider, fragmentListProviders)
                                .commit();
